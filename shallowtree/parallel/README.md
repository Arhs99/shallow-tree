...
On my home PC with 1 GPU NVIDIA RTX4070Ti, the [smiles.txt](/tests/fixtures/smiles.txt) file with 80 SMILES took ~7 mins to run which is about 5 sec per molecule.
